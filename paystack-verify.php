...
if(!$_SERVER["REQUEST_METHOD"] == "GET" && !$_GET['reference']){
    header('Location : pay.php');
    exit;
}else{
    $ref = $validate->validateEncrypVal($_GET['reference']);
} 
  ...
  curl_setopt_array($curl, array(
    ...
    CURLOPT_HTTPHEADER => array(
      "Authorization: Bearer sk_test_e562af23a16a5b50078b5848e86dd5a7d27ada9f",
 ...
 //declare an array that will contain the result
  ...
  if($response){
    ...
    echo '
            ...
            swal({
                title: "Oops",
                text: "Something went wrong,<br> contact our help center!",
                icon: "error",
                button: "Ok",
              }).then(function(){
